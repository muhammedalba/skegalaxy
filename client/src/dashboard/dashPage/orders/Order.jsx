...
const Order = () => {
  ...
  const [
    createOne,
    { error: createError, isLoading: createLoading, isSuccess: createSuccess },
  ] = useCreateOneMutation();
  ...
  const sendDeliveryReceiptImage = useCallback(
    (e) => {
      e.preventDefault();
        ...
        <Fade delay={0} direction="up" triggerOnce={true} cascade>
          {isLoading ? (
            ...
            <div className="row m-0 w-100 ">
              <span className="fs-5 p-3 text-center text-success ">
                معلومات المشتري
              </span>
              ...
              <div
                ...
                className="fs-5 py-2 border pointer col-12  text-primary "
              >
                وصل التحويل
                <img
                  height={150}
                  width={150}
                  className=" text-dark m-auto d-block"
              ...
              <div className="col-md-12 py-3 fs-5 py-2 border col-12  text-primary">
                ...
                >
                  ارسال فاتوره(pdf) :
                  {order?.data?.orderPdf ? (
                    <span className="text-success"> ( تم الارسال ) </span>
                  ) : (
                    ""
                  )}
                  <button
                    disabled={isLoading || createLoading || updateLoading}
                    className={
                      order?.data?.orderPdf
                        ? "m-2 btn btn-success p-1 text-white"
                        : "d-none"
                    }
                    type="button"
                    onClick={DownloadPdf}
              ...
              <div className="col-md-12 py-3 fs-5 py-2 border col-12  text-primary">
                ...
                >
                  ...
                  {order?.data?.DeliveryReceiptImage ? (
                    <span className="text-success"> ( تم الارسال ) </span>
                  ) : (
                    ""
                  )}
              ...
              <div className="my-2 border-bottom py-2 d-flex align-items-center justify-content-evenly flex-wrap gap-2">
                  ...
                  >
                    {order?.data?.isDelivered ? (
                      ...
                      <button
                        ...
                        onClick={() =>
                          handleAction(order?.data?._id, "deliver")
                        }
                ...
                <Fade delay={0} direction="up" triggerOnce={true}>
                  <button
                    disabled={updateLoading || isLoading || createLoading}
                    onClick={sendInvoice}
                    className={
                      order?.data?.orderPdf
