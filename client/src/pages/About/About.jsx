                ...
                <div className="col-md-7 ">
                  <div className="mt-4">
                    <Fade direction="up" triggerOnce cascade>
                      ...
                      <p className="mt-3 text-dark">
                        لعمل الدائم على افتتاح فروع في جميع أنحاء المملكة مما
                        يؤهلنا إلى حجز مكان ريادي في هذا المجال ونصبح دوما
                        الخيار الأول للعملاء الذين يبحثون عن التميز نسعى دائما
                    ...
                    <div className="mt-4">
                      <Fade direction="up" triggerOnce cascade>
                        ...
                        <p className="mt-3 text-dark">
                          ...
                          العزل المائي والحراري تقديم حلول متطورة لخدمات العزل
                          المائي والحراري عن طريق الاهتمام بالجودة العالمية وفهم
                          نشاط العملاء ووضع اسعار تنافسية لفهم احتياجاتكم تقديم
